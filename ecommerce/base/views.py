...
from ecommerce.base.forms import CheckoutForm, PaymentForm, CouponForm, RefundForm
from ecommerce.base.models import Item, OrderItem, Order, Address, Payment, UserProfile, Coupon, Refund
...
class RequestRefundView(View):
    def get(self, *args, **kwargs):
        ...
        return render(self.request, "base/request_refund.html", context)
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            try:
                ...
                return redirect("base:request-refund")
